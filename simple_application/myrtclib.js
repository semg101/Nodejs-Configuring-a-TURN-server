...
/*Here, configuration is  an  entity  that  contains  different options to  create  a peer
connection  object. T o utilize your  TURN  server ,  you should  use something like  the
following:*/
var pc_config = {
  'iceServers': [
  {
